...
import { useAnswerSheetStore } from '../../../store';
import { useCamera } from './useCamera';
import { useImagePicker } from './useImagePicker';
import { AnswerSheetPage } from '../../../types';

interface UseAnswerSheetImagesReturn {
  pages: AnswerSheetPage[];
  selectedPageId: string | null;
  selectedPage: AnswerSheetPage | undefined;
  isLoading: boolean;
...
export const useAnswerSheetImages = (): UseAnswerSheetImagesReturn => {
  const {
    pages,
    selectedPageId,
    isLoading,
